...
function ResDash(){
    ...
    async function acceptedOrderBtn(e){
        ...
        try {
            // let dataRef1 = doc(db , 'CusUsers' , userOrderId , 'acceptedOrders' , state.authUser.UID)
            // await setDoc(dataRef1 , {
    ...
    async function deliveredBtn(e){
        ...
        try {
            // let dataRef1 = doc(db , 'CusUsers' , userOrderId , 'deliveredOrders' , state.authUser.UID)
            // await setDoc(dataRef1 , {
